...
def _shard_token(x, sharding):
  ...
  return array._array_shard_arg(x._buf, sharding)
...
def _token_global_result_handler(global_aval, out_sharding, committed):
  ...
  array_handler = array._array_global_result_handler(
...
global_result_handlers[core.AbstractToken] = _token_global_result_handler
